...
public class TemplateController extends Controller {
	...
	Form<PreTemplate> filledForm = templateForm.bindFromRequest();
        ...
        if (filledForm.hasGlobalErrors() || filledForm.hasErrors()) {
            return badRequest(manageTemplates.render(ScheduleTemplate.find.all(), filledForm, sessionForm, "", Learner.LEARNER_TYPES));
        } else {
	...
	public static Result createSessionTemplate(String scheduleID){
		...
		if (filledForm.hasGlobalErrors() || filledForm.hasErrors()) {
            ...
            SessionTemplate st = new SessionTemplate(template.location, template.physician, template.week, template.day, AMtime);
